...
@Configuration
@EnableJpaRepositories(basePackages = "com.techgeeknext.repository.company", entityManagerFactoryRef = "companyEntityManagerFactory", transactionManagerRef = "companyTransactionManager")
public class CompanyDataSourceConfiguration {

	/**
	 * Here it will get url, username, password and driver-class-name which we have
	 * defined in application properties file for company.
	 * 
	 * @return
	 */
	@Bean
	 ...
	 * com.techgeeknext.entities.company.Company).
	 * 
	 * @param builder
	 * @return
	 */
