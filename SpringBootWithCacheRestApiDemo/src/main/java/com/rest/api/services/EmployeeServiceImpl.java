...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Cacheable(value = "cacheEmployeeInfo", key = "#id")
	@Override
	...
	@CacheEvict(value = "employee_data", key = "#id") // removing entries from the cache by id
	@Override
	...
	@CachePut(cacheNames = "employee", key = "#id") // updating cache entries from the cache by id
	@Override
